        ...
        <div className='max-w-[90%] lg:max-w-3xl mx-auto my-10 font-jost'>
            <form action="" className='w-full shadow-md p-4 '>
                ...
                <div className='mb-3'>
                    ...
                    <input type="phone number" className='w-full p-2 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-black transition-all ease-in-out' placeholder='Enter your phone number...' />
                </div>
                <div className='mb-3'>
                    <label>Message <span className='text-red-500'>*</span></label>
                    <textarea type="phone number" className='w-full p-2 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-black transition-all ease-in-out' placeholder='Enter your ...'>
                    </textarea>
                </div>
